...
//     const { StakeTogether, owner, user1, user2 } = await loadFixture(defaultFixture)
...
//     const { StakeTogether, owner, user1, user2, user3, user4 } = await loadFixture(defaultFixture)
...
//     const totalShares1 = await StakeTogether.getTotalShares()
...
//     await connect(StakeTogether, user1).stake(user3, {
//       value: stakeAmount2
//     })

//     const totalPooledEther2 = await StakeTogether.getTotalPooledEther()
//     const totalShares2 = await StakeTogether.getTotalShares()
...
//     const { StakeTogether, user1, user2, user3, user4 } = await loadFixture(defaultFixture)

//     const stakeAmountUser4 = ethers.parseEther('1')
//     const stakeAmountUser2 = ethers.parseEther('2')

//     await connect(StakeTogether, user1).stake(user4, {
...
//     await connect(StakeTogether, user2).stake(user4, {
//       value: stakeAmountUser1
//     })
