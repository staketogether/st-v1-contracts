...
import { MockStakeTogether } from '../../../typechain/contracts/ethereum/mocks'
import {
  Airdrop__factory,
...
export async function airdropFixture() {
  ...
  const UPGRADER_ROLE = await airdrop.airdropContract.UPGRADER_ROLE()
  const ADMIN_ROLE = await airdrop.airdropContract.ADMIN_ROLE()
