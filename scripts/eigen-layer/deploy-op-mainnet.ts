...
function checkDeployVariables() {
  ...
  if (!process.env.OP_MAINNET_BRIDGE_ADDRESS) missingVariables.push('OP_MAINNET_BRIDGE_ADDRESS')
  if (!process.env.OP_MAINNET_FEE_ADDRESS) missingVariables.push('OP_MAINNET_FEE_ADDRESS')
...
export async function deploy() {
  ...
  const bridgeContract = String(process.env.OP_MAINNET_BRIDGE_ADDRESS)
...
export async function configContracts(
  ...
  const feeAddress = process.env.OP_MAINNET_FEE_ADDRESS as string
...
async function verifyContracts(
  ...
  console.log(`npx hardhat verify --network op-mainnet ${airdropProxy} &&`)
  console.log(`npx hardhat verify --network op-mainnet ${airdropImplementation} &&`)
  console.log(`npx hardhat verify --network op-mainnet ${withdrawalsProxy} &&`)
  console.log(`npx hardhat verify --network op-mainnet ${withdrawalsImplementation} &&`)
  console.log(`npx hardhat verify --network op-mainnet ${routerProxy} &&`)
  console.log(`npx hardhat verify --network op-mainnet ${routerImplementation} &&`)
  console.log(`npx hardhat verify --network op-mainnet ${stakeTogetherProxy} &&`)
  console.log(`npx hardhat verify --network op-mainnet ${stakeTogetherImplementation}`)
}
