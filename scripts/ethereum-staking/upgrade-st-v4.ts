...
import { StakeTogetherV4__factory } from '../../typechain'
...
async function upgrade() {
  ...
  const StakeTogether = new StakeTogetherV4__factory(owner)

  console.log(`Upgrading StakeTogetherV4...`)

  const upgradedContract = await upgrades.upgradeProxy(proxyAddress, StakeTogether, {
    redeployImplementation: 'always',
  })
  console.log(`Upgraded To StakeTogetherV4`)

  console.log('Initializing V4...')
  await upgradedContract.initializeV4()
  console.log('Initialized V4')
