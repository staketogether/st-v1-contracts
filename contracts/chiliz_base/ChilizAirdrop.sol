  ...
  IChilizAirdrop
{
  ...
  IChilizRouter public router; // The reference to the Router contract for routing related operations.
  IChilizStakeTogether public stakeTogether; // The reference to the StakeTogether contract for staking related operations.
