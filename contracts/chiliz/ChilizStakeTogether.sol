...
contract ChilizStakeTogether is
  Initializable,
  ERC20Upgradeable,
  ...
  IChilizStakeTogether
{
  ...
  function totalSupply() public view override(ERC20Upgradeable, IChilizStakeTogether) returns (uint256) {
  ...
  function balanceOf(
    address _account
  ) public view override(ERC20Upgradeable, IChilizStakeTogether) returns (uint256) {
  ...
  function transfer(
    address _to,
    uint256 _amount
  ) public override(ERC20Upgradeable, IChilizStakeTogether) returns (bool) {
